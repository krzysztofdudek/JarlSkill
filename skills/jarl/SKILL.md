...
1. **Boot.** `handoff read` (a handoff marked STALE is a pointer, not the state: trust the live parts it prints), then `goal.md`, `decisions.md`, the tail of `log.md`, `status`, `list`, and
